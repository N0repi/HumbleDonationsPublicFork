...
// import MY_TOKEN_LISTjs from "./tokenList_GvT.js"
const inter = Inter({ subsets: ["latin"] })

// const UniTokenListUri = "https://gateway.ipfs.io/ipns/tokens.uniswap.org" //works
// const testTokenListUri = "./uni-dflt-tokenList_GvT-test.json" // does not work

// not adding provider to SwapWidget == Connect button does not require aditional (uniswap) wallet authentication.
// Without having a provider, wallets connected to the website is the only authentication need -> it skips a few clicks.
//const provider = new ethers.providers.JsonRpcProvider(API_URL_MUMBAI)

// Pasting tokenList json in js format here due to needing to wrap json in a IP(F/N)S URI under 30 charcs

const MY_TOKEN_LISTjs = [
    {
        chainId: 1,
    ...
    {
        chainId: 11155111,
        address: "0x9680ce83d7b7ffa73a70d8c02cf9b51df122f45d",
        name: "GovToken",
        symbol: "GvT",
        decimals: 18,
        logoURI:
            "https://maroon-blank-stoat-172.mypinata.cloud/ipfs/QmNUQGjPwAN3Bg7MX12wQ4Z29E32375W3w8SjGmrTH9gar/temp-token-logo.png",
    },
    {
        chainId: 1,
...
// native switching between networks
const API_URL_SEPOLIA = process.env.API_URL_SEPOLIA
const API_URL_MUMBAI = process.env.API_URL_MUMBAI
const API_URL_ARBITRUM = process.env.API_URL_ARBITRUM
const API_URL_GOERLI = process.env.API_URL_GOERLI
const API_URL_ARBITRUMSEPOLIA = process.env.API_URL_ARBITRUMSEPOLIA
const jsonRpcUrlMap = {
    1: [API_URL_ARBITRUMSEPOLIA],
    2: [API_URL_MUMBAI],
    3: [API_URL_ARBITRUM],
    4: [API_URL_GOERLI],
    5: [API_URL_SEPOLIA],
}
// native switching between networks - still an issue with Arbitrum Goerli, but might not have supported tokens in tokenList
// swaps for WETH and WMATIC were successful on Mumbai
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Humble Donations" />
                ...
                <div className={styles.centeredContainer}>
                    {
                        <div className="Uniswap">
                            <SwapWidget
                                provider={API_URL_MUMBAI}
                                jsonRpcUrlMap={jsonRpcUrlMap}
                                tokenList={MY_TOKEN_LISTjs}
                                // NEED SHORTER URI FOR TOKEN LIST
                                defaultOutputTokenAddress={
                                    "0x301944751abB2F5000C71B050b139e31AEaE4720"
                                }
                                onConnectWalletClick={false}
                                hideConnectionUI={true}
                                // *****
                                // FOR TESTING - widget only pulls accurate price data is the wallet rpc for the used network (metamask), matches the provier rpc. Otherwise, tx's cannot go through and the app will not get accurate price data.
                                // *****
                            />
                        </div>
                    }
